 ...
 * This BalloonOverlayView is part of an open source code base that is part of the balloon overlay which is an balloon image that is overlayed on the mapview when a user selects a helper.
